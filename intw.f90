...
!hliuftc---------------------------------------------------------
  if( wptr%kx <240 .or. wptr%kx > 260) then    !non-AMV winds
!hliuftc--------------------------------------------------------
...
!    Forward model
     valu= valu + (w1* su(i1)+w2* su(i2)+w3* su(i3)+w4* su(i4)+&
          w5* su(i5)+w6* su(i6)+w7* su(i7)+w8* su(i8)) * wptr%wftc(k)
     valv= valv + (w1* sv(i1)+w2* sv(i2)+w3* sv(i3)+w4* sv(i4)+&
          w5* sv(i5)+w6* sv(i6)+w7* sv(i7)+w8* sv(i8)) * wptr%wftc(k)
   enddo
